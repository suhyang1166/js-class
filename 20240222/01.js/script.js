...
// 생성자함수 혹은 클래스를 활용해서 프로토타입 형태의 객채를 생성하고, 해당 객체의 형태를 활용해서 또다른 객체를 만들게되면 해당 객체를 인스턴스 객체!

// 생성자함수 || 클래스 => 프로토타입 객체 => 인스턴스 객체
...
//   // this.title = title;
//   // this.price = price; .call(this, key,key)
...
// // 상속하고자하는 요소와 상속받고자하는 요소를 함수안에 매개변수로 넣어줘야 상속이 가능

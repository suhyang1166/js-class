...
// let open = new Date(2024, 1, 23); >> 2월로 가져옴 0부터 시작이기에
let open = new Date(2023, 12, 23);
// let open = new Date("2024/1/23");
console.log(open);

// JS의 시간의 세계관
// 1초 / 2초가 아닌 밀리초의 개념을 사용
// 1초 = 1000밀리초
// 1밀리초 = 1/1000초
// 1분 = 60초 = 60,000밀리초 (60 * 1000)
// 1시간 = 60분 = 3600초 = 3,600,000밀리초 (60 * 60 * 1000)
// 1일 = 24시간 = 1440분 = 86,400초 = 86,400,000밀리초 (24 * 60 * 60 * 1000)

...
// let hightScores = scores.filter((score, index) => {
//   if (score >= 85) {
...
// 프로그래밍 언어 : 대문자 & 소문자!
// JS : 자료형! => 객체 & 배열
// 객체 => 자료에 대한 값을 저장.관리 => 키,값 => 프로퍼티
// forEach / for...of / for문과 같은 값을 반복적으로 실행시킬 수 있는 함수가 매우 부족!

// // 메서드 체이닝 기법 => 1개의 객체에 마치 체인처럼 복수의 메서드 함수를 연달아서 사용하는 모습
// let bag = new Map();
// bag.set("color", "red");
// bag.set("type", "mini").set("purpose", "daliy");

// // bag.set("type", "mini");
// // bag.set("purpose", "daliy");
...
// 2) Map객체 : 중복되는 값이 존재할 수도 있다 VS Set : 절대로 증복되는 값을 가질 수 없음!

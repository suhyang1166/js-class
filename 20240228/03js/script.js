...
// Asynchronous Javascript And XML (비동기 형식의 XML형식)

// 웹 & 서버가 비동기 네트워크 통신 방법
// 1) fetch()
// 2) XMLHttpRequest()
...
// 0 : 클라이언트가 서버측에 아무런 요청을 하지않은 상태
// 1 : 클라이언트가 서버로 자료를 요청허고 성공한 상태
...
// try문 : 정상적으로 클라이언트 & 서버 소통이 이루어지고 있을 때
// catch : 오류가 발생했을 때
// finally문 : try || catch => 클라이언트 & 서버 통신!

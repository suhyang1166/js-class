/* for 문 */
/* 자바스크립트에서 반복문을 사용할 수 있는 데이터의 형식은 배열 */
...
/* 1) 온점 표기법 : bestSeller.title & 2) 대괄호 표기법 : bestSeller["title"]  */
...
// 수학 > 소수 : 1과 자기 자신만으로만 나눌 수 있는 숫자
// 소수 : 2, 3, 5, 7 소수!!! && 1은 소수가 아님!!!
// "조건식"을 활용해서 2부터 숫자가 "반복적"으로 증가하도록 설정
// 숫자가 증가할 때마다, 사용자가 입력한 해당 숫자를 나눠볼 수 있도록 설정
// 해당 숫자의 크기만큼 반복할 때, 한 번도 나눠지지 않는다면 = 소수라고 인식!!!
...
// 변수를 선언만 함!!
// 사용자가 입력한 값이 소수라고 한다면, 이 비어있는 변수 공간 true
...
// 3.반복문 중 "for문"을 사용해서 구구단 2~5단까지 웹 브라우저 출력해보세요!
// 2 x 1 = 2 ~ 2 x 9 * 5단

// 1) 숫자가 2부터 5까지 증가할 수 있는 코드를 작성한다!
// 2) 숫자가 2부터 5까지 증가했다면, 그 증가한 숫자에 다시 1부터 9까지 곱해야한다
// 2_1) 1부터 9까지의 숫자는 어디에서?
// 2_2) 1부터 9까지의 숫자는 또다시 반복해서 증가를 시켜줘야 한다!!!
